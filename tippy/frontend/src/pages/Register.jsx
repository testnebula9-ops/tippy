    ...
    <div className="page-sm">
      <div style={{ textAlign: 'center', marginBottom: 36 }}>
        <Link to="/" className="nav-logo" style={{ fontSize: 22 }}>
          tippy<span style={{ color: 'var(--purple)' }}>.mn</span>
        </Link>
        <h1 style={{ fontSize: 24, fontWeight: 600, marginTop: 24, marginBottom: 8 }}>Бүртгүүлэх</h1>
        <p style={{ color: 'var(--text2)', fontSize: 14 }}>
          Эсвэл <Link to="/login" style={{ color: 'var(--purple)' }}>нэвтрэх</Link>
        </p>
      </div>
      <div className="card">
        <form onSubmit={submit}>
          <div className="form-group">
            <label className="form-label">
              Username <span style={{ color: 'var(--text3)', fontWeight: 400 }}>(tippy.mn/username)</span>
            </label>
            <input
          ...
          <div className="form-group">
            ...
            <input
              ...
              placeholder="Монгол нэр ч болно"
            />
          </div>
          <div className="form-group">
